...
public class MovieData implements Serializable {
	...
	public void setMoviesList(List<Map<String, ?>> savedMovie) {
		moviesList = savedMovie;
	}
	...
	public void removeAllItem(){
		moviesList.removeAll(Collections.singleton(null));
	}
	...
	public void setItem(int i, HashMap<String, ?> movie){
		if(i >=0 && i < moviesList.size()){
